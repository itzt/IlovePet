...
<div class="logo">
    <a href="index.html">
        ...
        <!--<object id="sp" type="image/svg+xml" data="images/logo.svg" width="233" height="54"></object>-->
    ...
    <div class="container">
        <div class="col-xs-12 col-lg-6 no-margin banner">
            <a href="category-grid-2.html">
                ...
                <img class="banner-image" alt="" src="/statics/images/blank.gif" data-echo="images/banners/banner-narrow-01.jpg" />
            </a>
        </div>
        <div class="col-xs-12 col-lg-6 no-margin text-right banner">
            <a href="category-grid-2.html">
                ...
                <img class="banner-image" alt="" src="/statics/images/blank.gif" data-echo="images/banners/banner-narrow-02.jpg" />
            </a>
        </div>
    </div><!-- /.container -->
            ...
            <div class="col-xs-12 col-md-7 no-margin">
                ...
                <div class="row no-margin">
                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                        <div class="product-item">
                            <div class="image">
                                <img alt="" src="/statics/images/blank.gif" data-echo="images/products/product-05.jpg" />
                            </div>
                            <div class="body">
                                <div class="label-discount clear"></div>
                                <div class="title">
                    ...
                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                        <div class="product-item">
                            <div class="image">
                                <img alt="" src="/statics/images/blank.gif" data-echo="images/products/product-06.jpg" />
                            </div>
                            <div class="body">
                                <div class="label-discount clear"></div>
                                <div class="title">
                    ...
                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                        <div class="product-item">
                            <div class="image">
                                <img alt="" src="/statics/images/blank.gif" data-echo="images/products/product-07.jpg" />
                            </div>
                            <div class="body">
                                <div class="label-discount clear"></div>
                                <div class="title">
                ...
                <div class="row no-margin">
                    ...
                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                        <div class="product-item">
                            <div class="image">
                                <img alt="" src="/statics/images/blank.gif" data-echo="images/products/product-08.jpg" />
                            </div>
                            <div class="body">
                                <div class="label-discount clear"></div>
                                <div class="title">
                    ...
                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                        <div class="product-item">
                            <div class="image">
                                <img alt="" src="/statics/images/blank.gif" data-echo="images/products/product-09.jpg" />
                            </div>
                            <div class="body">
                                <div class="label-discount clear"></div>
                                <div class="title">
                    ...
                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                        <div class="product-item">
                            <div class="image">
                                <img alt="" src="/statics/images/blank.gif" data-echo="images/products/product-10.jpg" />
                            </div>
                            <div class="body">
                                <div class="label-discount clear"></div>
                                <div class="title">
            ...
            <div class="col-xs-12 col-md-5 no-margin">
                <div class="product-item-holder size-big single-product-gallery small-gallery">
                    ...
                    <div id="best-seller-single-product-slider" class="single-product-slider owl-carousel">
                        <div class="single-product-gallery-item" id="slide1">
                            <a data-rel="prettyphoto" href="images/products/product-gallery-01.jpg">
                                <img alt="" src="/statics/images/blank.gif" data-echo="images/products/product-gallery-01.jpg" />
                            </a>
                    ...
                    <div class="gallery-thumbs clearfix">
                        <ul>
                            <li><a class="horizontal-thumb active" data-target="#best-seller-single-product-slider" data-slide="0" href="#slide1"><img alt="" src="/statics/images/blank.gif" data-echo="images/products/gallery-thumb-01.jpg" /></a></li>
                            <li><a class="horizontal-thumb" data-target="#best-seller-single-product-slider" data-slide="1" href="#slide2"><img alt="" src="/statics/images/blank.gif" data-echo="images/products/gallery-thumb-01.jpg" /></a></li>
                            <li><a class="horizontal-thumb" data-target="#best-seller-single-product-slider" data-slide="2" href="#slide3"><img alt="" src="/statics/images/blank.gif" data-echo="images/products/gallery-thumb-01.jpg" /></a></li>
                        </ul>
                    </div><!-- /.gallery-thumbs -->
            ...
            <div id="owl-recently-viewed" class="owl-carousel product-grid-holder">
                <div class="no-margin carousel-item product-item-holder size-small hover">
                    <div class="product-item">
                        <div class="ribbon red"><span>sale</span></div> 
                        <div class="image">
                            <img alt="" src="/statics/images/blank.gif" data-echo="images/products/product-11.jpg" />
                        </div>
                        <div class="body">
                            <div class="title">
                ...
                <div class="no-margin carousel-item product-item-holder size-small hover">
                    <div class="product-item">
                        <div class="ribbon blue"><span>new!</span></div> 
                        <div class="image">
                            <img alt="" src="/statics/images/blank.gif" data-echo="images/products/product-12.jpg" />
                        </div>
                        <div class="body">
                            <div class="title">
                ...
                <div class=" no-margin carousel-item product-item-holder size-small hover">
                    <div class="product-item">
                        ...
                        <div class="image">
                            <img alt="" src="/statics/images/blank.gif" data-echo="images/products/product-13.jpg" />
                        </div>
                        <div class="body">
                            <div class="title">
                ...
                <div class=" no-margin carousel-item product-item-holder size-small hover">
                    <div class="product-item">
                        <div class="ribbon blue"><span>new!</span></div> 
                        <div class="image">
                            <img alt="" src="/statics/images/blank.gif" data-echo="images/products/product-14.jpg" />
                        </div>
                        <div class="body">
                            <div class="title">
                ...
                <div class=" no-margin carousel-item product-item-holder size-small hover">
                    <div class="product-item">
                        <div class="ribbon green"><span>bestseller</span></div> 
                        <div class="image">
                            <img alt="" src="/statics/images/blank.gif" data-echo="images/products/product-15.jpg" />
                        </div>
                        <div class="body">
                            <div class="title">
                ...
                <div class=" no-margin carousel-item product-item-holder size-small hover">
                    <div class="product-item">
                        ...
                        <div class="image">
                            <img alt="" src="/statics/images/blank.gif" data-echo="images/products/product-16.jpg" />
                        </div>
                        <div class="body">
                            <div class="title">
        ...
        <ul>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="/statics/images/blank.gif" data-echo="images/products/product-small-01.jpg" />
                        </a>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="/statics/images/blank.gif" data-echo="images/products/product-small-02.jpg" />
                        </a>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="row">                        
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="/statics/images/blank.gif" data-echo="images/products/product-small-03.jpg" />
                        </a>
                    </div>
                </div>
            </li>
        ...
        <ul>
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="/statics/images/blank.gif" data-echo="images/products/product-small-04.jpg" />
                        </a>
                    </div>
                </div>
            ...
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="/statics/images/blank.gif" data-echo="images/products/product-small-05.jpg" />
                        </a>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="/statics/images/blank.gif" data-echo="images/products/product-small-06.jpg" />
                        </a>
                    </div>
                </div>
            </li>
        ...
        <ul>
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="/statics/images/blank.gif" data-echo="images/products/product-small-07.jpg" />
                        </a>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="/statics/images/blank.gif" data-echo="images/products/product-small-08.jpg" />
                        </a>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="/statics/images/blank.gif" data-echo="images/products/product-small-09.jpg" />
                        </a>
                    </div>
...
<!-- ============================================================= FOOTER : END ============================================================= -->   </div><!-- /.wrapper -->
    ...
    <!-- <script src="/statics/http://maps.google.com/maps/api/js?sensor=false&amp;language=en"></script> -->
    ...
    <!-- <script src="/statics/http://w.sharethis.com/button/buttons.js"></script> -->
