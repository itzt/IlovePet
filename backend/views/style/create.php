    ...
    <div class="container-fluid">
        <div id="pad-wrapper" class="new-user">
            <div class="row-fluid header">
                <h3>添加新品种</h3>
            <a href="<?= Url::to(['style/index'])?>" class="btn-flat success pull-right">
                        <span>&#43;</span>
                        返回列表
                    </a>
            </div>
            ...
            <div class="row-fluid form-wrapper">
                ...
                <div class="span9 with-sidebar">
                    <div class="container">
                        ...
                        <?= $form->field($model, 'parent_id')->dropDownList($styList, ['prompt' => '选择品种', 'style' => 'height:30px'])->label('宠物品种'); ?>
                        <?= $form->field($model, 'name')->label('品种'); ?>
                        <label for=""></label>
                        <?= Html::submitButton('Create Kind', ['class' => 'btn']); ?>
                        <span>OR</span>
