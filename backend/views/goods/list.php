        ...
        <div id="pad-wrapper" class="users-list">
            ...
            <?= Html::beginForm(['goods/list'], 'get');?>
                <div class="pull-right" style="width:960px;">
                    ...
                    <div class="ui-select">
                        <?= Html::dropDownList('property', $map['property'], ['is_best' => '精品', 'is_new' => '新品', 'is_hot' => '热销', 'is_promote' => '特价'], ['prompt' => '请选择推荐...']);?>
                    </div>  
                    <div class="ui-select">
                        <?= Html::dropDownList('sale', $sale, ['1' => '上架', '0' => '下架'], ['prompt' => '销售状态...']);?>
                    </div>
